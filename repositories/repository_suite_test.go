...
VALUES (20, uuid_v4(), NOW(), NOW(), "John", "Smith", "johnsmith26@abc.com", "$2a$10$3QxDjD1ylgPnRgQLhBrTaeqdsNaLxkk7gpdsFGUheGU2k.l.5OIf6", 1)
`)
	suite.DB.Exec(`
...
(1, uuid_v4(),'2022-04-06 05:46:03.528','2022-04-06 05:46:03.528',NULL,1,20,20,NULL,'ABC Item 1','Item 1 Description','1','ABC','20000', "2099-01-01"),
(2, uuid_v4(),'2022-04-06 06:46:03.528','2022-04-06 06:46:03.528',NULL,1,20,20,NULL,'ABC Item 2','Item 2 Description','1','ABC','22000', "2099-01-01")
;
`)

	suite.repository = NewRepository(suite.DB)
	suite.actionUser = suite.repository.FindUserById(20)
